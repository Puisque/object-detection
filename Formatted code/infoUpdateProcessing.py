            ...
            if (len(output_info_collection[i][1][j]) != 0):
                print(
                    'This correspond to the {0} second {1} frame, type is: {2}, with accuracy {4}, location: {3}'.format(
                        i, j, output_info_collection[i][1][j][0]['name'],
                        output_info_collection[i][1][j][0]['box_points'],
                        output_info_collection[i][1][j][0]['percentage_probability']))
                ...
                print("****************************")
                frame_info = {'second': i, 'frame': j, 'type': output_info_collection[i][1][j][0]['name'],
                              'accuracy': output_info_collection[i][1][j][0]['percentage_probability'],
                              'location': output_info_collection[i][1][j][0]['box_points'], 'area': object_area,
