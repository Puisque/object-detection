...
def eliminate_one_sec(bArr):
    # for i in bArr:
    #     print(i['time'])
    #     for l in range(len(i['time'])):
    #         print(l)
    #         print(i['time'][l])
    #         print(i['time'][l][0])
    #         print(i['time'][l][1])
    #         if i['time'][l][0] == i['time'][l][1]:
    #             i['time'].pop(l)
    for arr in bArr:
        timeSement = arr['time']
        print(timeSement)
        arr['time'] = [x for x in timeSement if x[0]!=x[1]]

    aArr = list(filter(lambda i: i['time'] != [], bArr))
    return aArr
